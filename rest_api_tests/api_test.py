...
def upscaler_test():
    ...
    print(f"[Upscaler] response from server was : {res.status_code}")
...
def img2img_test():
    ...
    print(f"[img2img]response from server was : {res.status_code}")
...
def inpainting_test():
    ...
    print(f"[Inpaint] response from server was : {res.status_code}")
